...
const Contacts = () => {
  ...
  return (
    <>
      <SEO
        title="Fale Conosco | Mesquita Barreto Advocacia"
        description="Entre em contato com o escritório Mesquita Barreto Advocacia. Av. Dom Luís, 1200, Aldeota, Fortaleza-CE. Tel: (85) 99613-5771."
        canonical="/contacts"
      />
      <div className={styles.container}>
        <Title text="Fale Conosco" as="h1" />
        ...
        <iframe
          ...
          title="Localização do escritório Mesquita Barreto Advocacia no mapa"
        ></iframe>
      </div>
    </>
  );
